                ...
                <div className="header">
                    <div className="container">
                        <div className="wr">
                            ...
                            <ul className="mnu">
                                <li><a href=".about-box">How it works</a></li>
                                <li><a href=".info-box">Statistics</a></li>
                                <li><a href=".tiers-box">Features</a></li>
                                <li><a href=".feature-box">About Us</a></li>
                                <li><a href=".socials-box">Social media</a></li>
                            </ul>
                            <a href="https://forms.gle/sugL3zcHP9buKeFQ7" className="btn-call">Apply for IDO</a>
                                ...
                                <div className="wr">
                                    <div className="tt">
                                        <ul className="soc-list">
                                            <li><a href="https://t.me/pulsepadann"><img src="https://pulsepad.io/img/sc2.svg" alt="" /></a></li>
                                            <li><a href="https://twitter.com/PulsePad_App"><img src="https://pulsepad.io/img/sc3.svg" alt="" /></a></li>
                                            <li><a href="https://medium.com/@PulsePad.io"><img src="https://pulsepad.io/img/sc4.svg" alt="" /></a></li>
                                        </ul>
                                    ...
                                    <div className="thebuttons">
                                        <a href="https://pancakeswap.finance/swap?outputCurrency=0x8a74bc8c372bc7f0e9ca3f6ac0df51be15aec47a" className="btn" >Buy on PancakeSwap</a>
                                        <a href="https://app.uniswap.org/#/swap?inputCurrency=0x8a74bc8c372bc7f0e9ca3f6ac0df51be15aec47a" className="btn" >Buy on UniSwap</a>
                                        <a href="https://exchange.wagyuswap.app/swap?inputCurrency=0x8a74bc8c372bc7f0e9ca3f6ac0df51be15aec47a" className="btn" >Buy on WagyuSwap</a>
                                        <a href="https://staking.pulsepad.io/" className="btn" >Staking</a>
                                    </div>
                    ...
                    <div className="container">
                        <div className="wr">
                            ...
                            <div className="txt-bx txt-dark animation_1">
                                ...
                                <ul>
                                    <li>Our legal department to help you set up the best jurisdiction for your token and project
                                    </li>
                                    <li>Expert tokenomics design and vesting schedule creation</li>
                                    <li>In house development support, token contract creation and auditing</li>
                                    <li>Access to our marketing and KOL network</li>
                                    <li>Exclusive access to our IDO platforms for the ultimate launch</li>
                                    <li>Invaluable industry connections via our advisor and extended network</li>
                                </ul>
                            </div>
                            <div className="apply-box ">
                                <div className="wr">
                                    ...
                                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScZ7NM9o0o3oZc_4kFAwA-_ePPZqSkYpn4ZxO9knCMB63jtdA/viewform" className="btn animation_1">Apply now</a>
                                    <div className="sc-t animation_1">
                                        <div className="t"><a className=" btn-call animation_1" href="https://bluezilla.vc/">Website</a></div>
                                        <div className="t"><a className=" btn-call animation_1" href="https://twitter.com/BlueZillaVc">Twitter</a></div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="bx bx1">
                                        <ul className="list">
                                            <li>
                                                ...
                                                <div className="t2"><a href="https://pulsepad.io/">pulsepad.io</a>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="t1">Telegram ANN</div>
                                                <div className="t2"><a href="https://t.me/pulsepadann">t.me/pulsepadann</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="bx bx2">
                                        <ul className="list">
                                            <li>
                                                ...
                                                <div className="t2"><a href="https://twitter.com/PulsePad_App">twitter.com/PulsePad_App</a>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="t1">Support</div>
                                                <div className="t2"><a href="https://bluezilla.jitbit.com/helpdesk/">Contact Support</a></div>
                                            </li>
                                            <li>
                                                <div className="t1">Medium</div>
                                                <div className="t2"><a href="https://medium.com/@PulsePad.io">medium.com/@PulsePad.io</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div className="footer">
                    <div className="container">
                        ...
                        <div className="copy-bx">
                            ...
                            <div className="t">
                                <a href="https://staking.pulsepad.io/terms-of-uses">Terms &amp;
                                    conditions</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="https://staking.pulsepad.io/privacy-policy">Privacy policy</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                <a href="https://staking.pulsepad.io/cookie-policy">Cookies policy</a>
                            </div>
                        </div>
                    </div>
                </div>
