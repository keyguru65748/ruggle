        ...
        <div className='mb-5 pb-5'>
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel1a-header"
                >
                    <Typography>When is the IDO taking place?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography>Will I need SOL in my wallet ?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography>   Will I need USDC ?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography>   Where will the token be listed post - IDO ? </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography>       How does the IDO work ? </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography>   Where do I need to start accruing my USDC ?  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>Your Phantom wallet! Phantom's code is battle tested and we love the focus they have on protecting their users. So, you'll just be connecting your Phantom wallet to the IDO site. Ez pz!</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography> Can I participate in the IDO even if I don't have a SSC NFT?  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>Of course! The IDO is not tied to owning a Shadowy Super Coder NFT.</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion className="mt-4">
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography> My transaction timed out while trying to deposit.  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
